...
Cada socio tiene:
    ...
    Un nombre Cada sala tiene:
    Un número identificador único dentro del gimnasio
    Descripción de la sala El gimnasio: El sistema debe permitir representar correctamente a cada socio y mostrar su información en formato legible.
...
Reglas Importantes
    ...
    No se permite usar generación automática de código (Generate → Getter/Constructor).
    No se permite copiar código de otros compañeros.
    No se permite utilizar IA generativa para escribir el código.
    El código debe seguir las buenas prácticas indicadas en clase.
